...
async function checkForUpdate(deploymentKey = null, handleBinaryVersionMismatchCallback = null, appVersion = null) {
  /*
   ...
   */
  const config = deploymentKey ? { ...nativeConfig, ...{ deploymentKey }, ...(appVersion ? { appVersion } : {}) } : nativeConfig;
